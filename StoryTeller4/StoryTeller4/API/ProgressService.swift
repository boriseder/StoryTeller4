...
// APIConfig is a struct (value type); NetworkService must also be Sendable
// (marked below). No shared mutable state exists post-construction.

final class DefaultProgressService: ProgressServiceProtocol, @unchecked Sendable {
